...
import com.andydennie.vroom.sample.webservice.domain.LinearMeasurement;
...
public class EmbeddedLinearMeasurementDao {
    ...
    // no-arg constructor needed for reflective instantiation by Objectify
    public EmbeddedLinearMeasurementDao() {
    }

    public EmbeddedLinearMeasurementDao(final LinearMeasurement measurement) {
