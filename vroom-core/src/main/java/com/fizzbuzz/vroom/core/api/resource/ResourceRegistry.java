...
public class ResourceRegistry {
    ...
    String getCanonicalUri(Class<KR> keyedResourceClass, String id) {
        return VroomApplication.buildUrlFromPath(getPath(keyedResourceClass, id));
    }

    public static <KR extends KeyedResource> String getCanonicalUri(Class<KR> keyedResourceClass, KeyType<?> key) {
        return VroomApplication.buildUrlFromPath(getPath(keyedResourceClass, key.toString()));
    }
    ...
    public static <R extends ICollectionResource> String getPath(Class<R> collectionResourceClass) {
        return VroomApplication.buildUrlFromPath(ResourceRegistry.getPathTemplate(collectionResourceClass));
    }
}
