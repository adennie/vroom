...
public abstract class BaseFilterableEntityCollection<
        KO extends KeyedObject<LongKey>,
        DAO extends BaseDao<KO>,
        FC>
        extends BaseEntityCollection<KO, DAO>
        implements FilterableEntityCollection<KO, FC> {

    protected BaseFilterableEntityCollection(final Class<KO> domainElementClass,
